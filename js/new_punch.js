...
$(document).ready(function(){
    ...
    $('#add_image_1').on('click', function(){
        ...
        if(add_image_1_click == 0){
            add_image_1_menu.find(".menu-item img").animate({left: "30px", top: "120px"}, 200);
            add_image_1_menu.find(":nth-child(2) img").animate({left: "93px", top: "90px"}, 200);
            add_image_1_menu.find(":nth-child(3) img").animate({left: "93px", top: "90px"}, 200);
            ...
            add_image_1_menu.find(":nth-child(3) img").animate({left: "93px", top: "165px"}, 200);
            add_image_1_menu.find(":nth-child(3) img").animate({left: "93px", top: "165px"}, 200);
            add_image_1_menu.find(":nth-child(2) img").animate({left: "93px", top: "165px"}, 200);
            add_image_1_menu.find(".menu-item img").animate({left: "93px", top: "165px"}, 200);
    ...
    $('#add_image_2').on('click', function(){
        ...
        if(add_image_2_click == 0){
            add_image_2_menu.find(".menu-item img").animate({left: "30px", top: "120px"}, 200);
            add_image_2_menu.find(":nth-child(2) img").animate({left: "93px", top: "90px"}, 200);
            add_image_2_menu.find(":nth-child(3) img").animate({left: "93px", top: "90px"}, 200);
            ...
            add_image_2_menu.find(":nth-child(3) img").animate({left: "93px", top: "165px"}, 200);
            add_image_2_menu.find(":nth-child(3) img").animate({left: "93px", top: "165px"}, 200);
            add_image_2_menu.find(":nth-child(2) img").animate({left: "93px", top: "165px"}, 200);
            add_image_2_menu.find(".menu-item img").animate({left: "93px", top: "165px"}, 200);
